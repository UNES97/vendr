...
<div class="max-w-4xl mx-auto px-4 lg:px-8">
    ...
    <div class="bg-white rounded-lg p-8 border border-gray-200">
        <h2 class="text-3xl font-bold text-gray-900 mb-6">Edit Meal Category</h2>

        <form method="POST" action="<?php echo base_url('inventory/edit_category/' . $category['id']); ?>" class="space-y-6">
            <!-- Category Name -->
            <div>
